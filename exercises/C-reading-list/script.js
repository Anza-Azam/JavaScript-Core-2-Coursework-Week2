function readingList(books) {
    ...
    books.forEach(book => {
        ...
        if (book.title === "The Design of Everyday Things") {
            bookImage.src = "https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1483319609l/13356708._SY475_.jpg"
        }

        if (book.title === "The Most Human Human") {
            bookImage.src = "https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1295465264l/8884400.jpg"
        }
        if (book.title === "The Pragmatic Programmer") {
            bookImage.src = "https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1401432508l/4099.jpg"
        }
